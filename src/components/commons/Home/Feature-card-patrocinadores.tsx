    ...
    >
      ...
      <div className='mx-auto grid justify-center items-center text-center gap-4 sm:grid-cols-2 md:max-w-[64rem] md:grid-cols-3 p-4'>
        <div className='overflow-hidden rounded-lg border border-gray-800 p-2'>
          <div className='bg-blue-400 flex h-[400px] flex-col justify-between rounded-md pl-13 p-2'>
          <Image
              src='/cta1.jpg'
              alt='Faça uma doação'
              width={300}
              height={300}
              className='border-8 border-blue-300 p-2 rounded-full'
            />
        ...
        <div className='overflow-hidden rounded-lg border border-gray-800 p-2'>
          <div className='bg-blue-400 flex h-[400px] flex-col justify-between rounded-md pr-13 p-2'>
          <Image
              src='/cta2.jpg'
        ...
        <div className='overflow-hidden rounded-lg border border-gray-800 p-2'>
          <div className='bg-blue-400 flex h-[400px] flex-col justify-between rounded-md p-2'>
          <Image
              src='/cta3.jpg'
              alt='Patrocínio'
              width={300}
        ...
        <div className='overflow-hidden rounded-lg border border-gray-800 p-2'>
          <div className='bg-blue-400 flex h-[400px] flex-col justify-between rounded-md p-3'>
            <Image
              src='/cta3.jpg'
              alt='Patrocínio'
              width={300}
